...
c        write(*,*) cdep,dg(mn,iplane),'#soillayer'
...
c           write(*,*) drawat(jj),jj,'waterdrained'
          else
            drawat(jj) = 0.0
          endif
        else
...
c     write(*,*) ddrain(drseq(nowcrp,iplane)),'tile depth'
...
c      write(*,*) drainq(iplane),'drainage iplane'
