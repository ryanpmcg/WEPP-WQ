...
!!    wsurfq(:)   |nn H2O        |surface runoff generated on day in subbasin
!!    ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
...
**        cy = .1 * sedyld / (da_ha * sub_fr(iwave) * wsurfq(iwave) +     &
**     &                                                            1.e-6)
      else
        !! HRU sediment calculations
        cy = .1 * sedyld / (da_ha * hru_fr(j) * surfq + 1.e-6)
      end if
...
c         write(*,*) enratio, 'enrichment ratio'
