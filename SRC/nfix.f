...
!! compute fixation as a function of no3, soil water, and growth stage
      ...
      fixn = Min(fixn, uno3l)
c      write(*,*) fixn, 'nitrogen fixation!!'
      open (2,file = "nfixtation.txt")
      write(2,*) curyr,fixn,'the current year, fixnitrogen!!'


!! summary calculations
      if (curyr > nyskip) then
        wshd_fixn = wshd_fixn + fixn * hru_fr(j)
      end if
